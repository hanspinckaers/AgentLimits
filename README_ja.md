...
- **メニューバーアイコンを隠す**: アイコンを完全に非表示にできます。非表示中にアプリを再起動（Finderダブルクリック / Spotlight / `open -a AgentLimits`）すると、一時的にアイコンが復活して設定画面が開きます。設定ウィンドウを閉じるとアイコンは再び非表示になります。
...
6. 「メニューバーアイコンを隠す」でアイコンを完全に非表示にできます。非表示中に設定を開くには、アプリを再起動してください。
